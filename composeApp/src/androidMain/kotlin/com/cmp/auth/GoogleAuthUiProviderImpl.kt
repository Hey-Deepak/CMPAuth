...
import feature.auth.GoogleAuthUiProvider
import model.GoogleAuthCredentials
...
internal class GoogleAuthUiProviderImpl(
    ...
    override suspend fun signIn(): GoogleUser? {
        return try {
            ...
            Log.e("TAG", "GoogleAuthUiProvider error: ${e.message}")
            null
        ...
        return when {
            credential is CustomCredential && credential.type == GoogleIdTokenCredential.TYPE_GOOGLE_ID_TOKEN_CREDENTIAL -> {
                try {
                    ...
                    Log.e("TAG","GoogleAuthUiProvider Received an invalid google id token response: ${e.message}")
                    null
                }
            }
